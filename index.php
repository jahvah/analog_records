...
if ($results && mysqli_num_rows($results) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($results)) {
        ...
        if ($loggedIn) {
            ...
            echo '<a href="http://localhost/analog_records/user/login.php" class="view_product" onclick="alert(\'Please login first to continue.\');" style="display:inline-block; padding:5px 10px; border:1px solid #007bff; border-radius:5px; text-decoration:none; color:#007bff;">View</a>';
        }
